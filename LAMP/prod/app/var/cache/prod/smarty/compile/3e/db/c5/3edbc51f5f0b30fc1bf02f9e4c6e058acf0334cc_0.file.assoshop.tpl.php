...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65fa0e31ed1a03_52851718',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3edbc51f5f0b30fc1bf02f9e4c6e058acf0334cc' => 
    array (
      0 => '/app/admin/themes/default/template/helpers/form/assoshop.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65fa0e31ed1a03_52851718 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
<div class="assoShop">
	<table class="table">
		<tr>
			<th><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Store','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</th>
		</tr>
		<tr>
			<td>
				<label>
					<input class="input_all_shop" type="checkbox" /><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All stores'),$_smarty_tpl ) );?>
...
[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['groupID']->value ));?>
]"
							value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['groupID']->value ));?>
"
						...
						<td <?php if ($_smarty_tpl->tpl_vars['groupData']->value['disable_shops']) {?>style="font-style:italic;background-color:#CFC4FF"<?php }?>>
							...
							<label class="child">
								<input class="input_shop"
									...
									value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['groupID']->value ));?>
"
									shop_id="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['shopID']->value ));?>
"
									name="checkBoxShopAsso_<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['shopID']->value ));?>
]"
									id="checkedBox_<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['shopID']->value ));?>
"
