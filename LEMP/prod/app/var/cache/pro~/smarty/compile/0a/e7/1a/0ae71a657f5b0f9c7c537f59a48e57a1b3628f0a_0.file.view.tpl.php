<?php
/* Smarty version 4.3.4, created on 2024-03-19 20:24:05
  from '/app/admin/themes/default/template/controllers/customer_threads/helpers/view/view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f465e822e8_38063446',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0ae71a657f5b0f9c7c537f59a48e57a1b3628f0a' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/customer_threads/helpers/view/view.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f465e822e8_38063446 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_83869756265f9f465e74760_46188359', "override_tpl");
?>
...
/* {block "override_tpl"} */
class Block_83869756265f9f465e74760_46188359 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'override_tpl' => 
  array (
    0 => 'Block_83869756265f9f465e74760_46188359',
  ),
);
...
: <span class="badge">#<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['id_customer_thread']->value ));?>
</span>
...
" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['action']->value['value'] ));?>
">
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers',true,array(),array('id_customer'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['customer']->value->id )),'viewcustomer'=>1)),'html','UTF-8' ));
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>"Customer since: %s",'sprintf'=>array($_prefixVariable4),'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) );?>
</p>
						</div>
					<?php }?>
				</div>
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['customer']->value->firstname,'html','UTF-8' ));?>
 ...
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['thread']->value->email;
	...
	<form action="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomerThreads',true,array(),array('id_customer_thread'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['thread']->value->id )),'viewcustomer_thread'=>1)),'html','UTF-8' ));?>
" method="post" enctype="multipart/form-data" class="form-horizontal">
	<div class="row">
		<div class="media">
			<div class="pull-left">
...
" alt=""><?php }?></span>
	...
	<div class="panel-footer">
		...
		<input type="hidden" name="id_customer_thread" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['thread']->value->id ));?>
" />
