<?php
/* Smarty version 4.3.4, created on 2024-03-19 20:24:06
  from '/app/admin/themes/default/template/controllers/customer_threads/message.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f466046cb6_87832956',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd44df3d733ae8a09d5bb38177ee243b57baa73fc' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/customer_threads/message.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f466046cb6_87832956 (Smarty_Internal_Template $_smarty_tpl) {
...
" title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View customer','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) ) ));?>
">
...
"
					title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View file','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) ) ));?>
">
						<i class="icon-search"></i>
					</a>
				</dd>
...
" title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl ) ) ));?>
...
<?php }?>
			<dl class="dl-horizontal">
				...
				<dd><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'nl2br' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['message']->value['message'],'html','UTF-8' )) ));?>
</dd>
			</dl>
		</div>
...
&amp;id_customer_thread=<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['message']->value['id_customer_thread'] ));?>
&amp;viewcustomer_thread=1" method="post" enctype="multipart/form-data" class="form-horizontal">
 ...
 <?php echo $_smarty_tpl->tpl_vars['message']->value['email'];?>
				...
				<div class="row">
					...
					<input type="hidden" name="id_customer_thread" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['message']->value['id_customer_thread'] ));?>
" />
