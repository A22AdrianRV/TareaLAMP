...
/* Smarty version 4.3.4, created on 2024-03-19 20:24:08
  from '/app/admin/themes/default/template/controllers/modules/js.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f468640428_34007943',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c3ec7054413c078de44537c22b1b0afd11acf91c' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/modules/js.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f468640428_34007943 (Smarty_Internal_Template $_smarty_tpl) {
...
';
	<?php if ((isset($_GET['anchor'])) && !(isset($_smarty_tpl->tpl_vars['error_module']->value))) {?>var anchor = '<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'htmlentities' ][ 0 ], array( $_GET['anchor'] )),'(',''),')',''),'{',''),'}',''),'\'',''),'/','');?>
';<?php } else { ?>var anchor = '';<?php }?>

	<?php if ((isset($_GET['module_name'])) && !(isset($_smarty_tpl->tpl_vars['error_module']->value)) && (!(isset($_smarty_tpl->tpl_vars['dont_filter']->value)) || !$_smarty_tpl->tpl_vars['dont_filter']->value)) {?>var module_name = '<?php echo smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(smarty_modifier_replace(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'htmlentities' ][ 0 ], array( $_GET['module_name'] )),'(',''),')',''),'{',''),'}',''),'\'',''),'/','');?>
