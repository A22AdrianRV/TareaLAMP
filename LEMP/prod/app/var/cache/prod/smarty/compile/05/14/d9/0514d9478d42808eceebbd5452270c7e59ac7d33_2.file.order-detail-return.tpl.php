<?php
/* Smarty version 4.3.4, created on 2024-03-19 20:38:41
  from '/app/themes/classic/templates/customer/_partials/order-detail-return.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f7d192d287_14819062',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0514d9478d42808eceebbd5452270c7e59ac7d33' => 
    array (
      0 => '/app/themes/classic/templates/customer/_partials/order-detail-return.tpl',
      1 => 1697822646,
      2 => 'file',
    ),
  ),
...
function content_65f9f7d192d287_14819062 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_44472710365f9f7d1910088_59124087', 'order_products_table');
?>

<?php }
/* {block 'order_products_table'} */
class Block_44472710365f9f7d1910088_59124087 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'order_products_table' => 
  array (
    0 => 'Block_44472710365f9f7d1910088_59124087',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

  <form id="order-return-form" class="js-order-return-form" action="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['urls']->value['pages']['order_follow'], ENT_QUOTES, 'UTF-8');?>
" method="post">
          ...
          <tr>
            <td>
              <?php if (!$_smarty_tpl->tpl_vars['product']->value['is_virtual']) {?>
                <span id="_desktop_product_line_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
">
                  <input type="checkbox" id="cb_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
" name="ids_order_detail[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
">
                </span>
              <?php }?>
            </td>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <td class="qty">
              ...
              <?php if ($_smarty_tpl->tpl_vars['product']->value['quantity'] > $_smarty_tpl->tpl_vars['product']->value['qty_returned'] && !$_smarty_tpl->tpl_vars['product']->value['is_virtual']) {?>
                <div class="select" id="_desktop_return_qty_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
">
                  <select name="order_qte_input[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
...
?>
                      <option value="<?php echo htmlspecialchars((string) (isset($_smarty_tpl->tpl_vars['__smarty_section_quantity']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_quantity']->value['index'] : null), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((string) (isset($_smarty_tpl->tpl_vars['__smarty_section_quantity']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_quantity']->value['index'] : null), ENT_QUOTES, 'UTF-8');?>
</option>
                    <?php
}
}
?>
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['product']->value['customizations']) {?>
                    <input type="hidden" value="1" name="customization_qty_input[<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customization']->value['id_customization'], ENT_QUOTES, 'UTF-8');?>
]" />
                  <?php }?>
                </div>
                <?php }?>
            </td>
            <td class="text-xs-right"><?php if (!$_smarty_tpl->tpl_vars['product']->value['is_virtual']) {
echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['qty_returned'], ENT_QUOTES, 'UTF-8');
}?></td>
...
">
                <td colspan="5"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['line']->value['label'], ENT_QUOTES, 'UTF-8');?>
</td>
                <td colspan="2"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['line']->value['value'], ENT_QUOTES, 'UTF-8');?>
</td>
              </tr>
            <?php }?>
          <?php
...
">
            <td colspan="5"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['order']->value['totals']['total']['label'], ENT_QUOTES, 'UTF-8');?>
</td>
            <td colspan="2"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['order']->value['totals']['total']['value'], ENT_QUOTES, 'UTF-8');?>
</td>
          </tr>
        </tfoot>
      </table>
...
?>
        <div class="order-item">
          <div class="row">
            <div class="checkbox">
              <?php if (!$_smarty_tpl->tpl_vars['product']->value['customizations']) {?>
                <span id="_mobile_product_line_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
"></span>
              <?php } else { ?>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['product']->value['customizations'], 'customization');
...
$_smarty_tpl->tpl_vars['customization']->do_else = false;
?>
                  <span id="_mobile_product_customization_line_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customization']->value['id_customization'], ENT_QUOTES, 'UTF-8');?>
"></span>
                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
: <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customization']->value['quantity'], ENT_QUOTES, 'UTF-8');?>
                          ...
                          <div class="s" id="_mobile_return_qty_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['id_order_detail'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customization']->value['id_customization'], ENT_QUOTES, 'UTF-8');?>
"></div>
                        <?php
}
...
: <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['product']->value['qty_returned'], ENT_QUOTES, 'UTF-8');?>
</div>
                      <?php }?>
                    </div>
