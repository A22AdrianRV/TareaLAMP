<?php
/* Smarty version 4.3.4, created on 2024-03-19 20:38:03
  from '/app/admin/themes/default/template/controllers/return/helpers/form/form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f7ab456c61_32755978',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c18bee48d846d6967c4a821e83534bc03d0f1539' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/return/helpers/form/form.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f7ab456c61_32755978 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_210572201865f9f7ab43aa98_28391722', "input");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'helpers/form/form.tpl');
}
/* {block "input"} */
class Block_210572201865f9f7ab43aa98_28391722 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'input' => 
  array (
    0 => 'Block_210572201865f9f7ab43aa98_28391722',
  ),
);
...
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['id_order_return']->value ));
$_prefixVariable9=ob_get_clean();
ob_start();
echo Tools::getAdminTokenLite('AdminReturn');
$_prefixVariable10=ob_get_clean();
ob_start();
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['employee']->value->id ));
$_prefixVariable11=ob_get_clean();
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['link']->value->getPageLink('pdf-order-return',true,NULL,"id_order_return=".$_prefixVariable9."&adtoken=".$_prefixVariable10."&id_employee=".$_prefixVariable11),'html','UTF-8' ));?>
">
...
?>
					<tr>
						...
						<td class="text-center"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['returnedCustomization']->value['product_quantity'] ));?>
</td>
...
?>
											<div class="form-group">
												...
												<div class="col-lg-9">
													<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCarts',true,array(),array('ajax'=>1,'action'=>'customizationImage','img'=>$_smarty_tpl->tpl_vars['data']->value['value'],'name'=>((call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['returnedCustomization']->value['id_order_detail'] ))).('-file')).((isset($_smarty_tpl->tpl_vars['__smarty_foreach_data']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_data']->value['iteration'] : null))));?>
...
?>
					<?php if (!(isset($_smarty_tpl->tpl_vars['quantityDisplayed']->value[$_smarty_tpl->tpl_vars['product']->value['id_order_detail']])) || call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['product_quantity'] )) > call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['quantityDisplayed']->value[$_smarty_tpl->tpl_vars['product']->value['id_order_detail']] ))) {?>
						<tr>
