...
/* Smarty version 4.3.4, created on 2024-03-19 20:37:54
  from '/app/admin/themes/default/template/controllers/carrier_wizard/helpers/form/form_ranges.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f7a2190932_29800581',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '33eb2e6cb7ce77ac0c52533e90236ebe1631b4dc' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/carrier_wizard/helpers/form/form_ranges.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f7a2190932_29800581 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
		<?php echo '<script'; ?>
>var zones_nbr = <?php echo smarty_modifier_count($_smarty_tpl->tpl_vars['zones']->value)+3;?>
...
?>
						<td class="border_bottom">
							<div class="input-group fixed-width-md">
								...
								<input class="form-control" name="range_inf[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['range']->value['id_range'] ));?>
...
?>
						<td class="border_bottom">
							<div class="input-group fixed-width-md">
								...
								<input name="form-control range_inf[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['range']->value['id_range'] ));?>
]" type="text" />
							</div>
						</td>
						<?php
...
?>
						<td class="range_data">
							<div class="input-group fixed-width-md">
								...
								<input class="form-control" name="range_sup[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['range']->value['id_range'] ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
					...
					<tr class="fees_all">
						<td class="border_top border_bottom border_bold">
							<span class="fees_all" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['ranges']->value) == 0) {?>style="display:none" <?php }?>>All</span>
						</td>
						<td style="">
...
?>
						<td>
							<div class="input-group fixed-width-md">
								...
								<input class="form-control" name="fees[<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['zone']->value['id_zone'] ));?>
][<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['range']->value['id_range'] ));?>
]" type="text"
