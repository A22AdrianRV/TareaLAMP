<?php
/* Smarty version 4.3.4, created on 2024-03-19 20:37:55
  from '/app/admin/themes/default/template/controllers/cart_rules/conditions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65f9f7a3624b74_14183412',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '85ff701933639ecd17c8c893a7594ab30a956bf8' => 
    array (
      0 => '/app/admin/themes/default/template/controllers/cart_rules/conditions.tpl',
      1 => 1707478622,
      2 => 'file',
    ),
  ),
...
function content_65f9f7a3624b74_14183412 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Optional: The cart rule will be available to everyone if you leave this field blank.','d'=>'Admin.Catalog.Help'),$_smarty_tpl ) ) ));?>
">
	...
	<div class="col-lg-9">
		<div class="input-group col-lg-12">
			...
			<input type="hidden" id="id_customer" name="id_customer" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'id_customer') ));?>
" />
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The default period is one month.','d'=>'Admin.Catalog.Help'),$_smarty_tpl ) ) ));?>
">
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You can choose a minimum amount for the cart either with or without the taxes and shipping.','d'=>'Admin.Catalog.Help'),$_smarty_tpl ) ) ));?>
">
	...
	<div class="col-lg-9">
		<div class="row">
			<div class="col-lg-3">
				<input type="text" name="minimum_amount" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'floatval' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'minimum_amount') ));?>
" />
			</div>
			<div class="col-lg-2">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="col-lg-3">
				<select name="minimum_amount_tax">
					...
					<option value="1" <?php if ($_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'minimum_amount_tax') === '1' || $_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'minimum_amount_tax') === false) {?>selected="selected"<?php }?>><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Tax included','d'=>'Admin.Global'),$_smarty_tpl ) );?>
</option>
				</select>
			</div>
			<div class="col-lg-4">
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The cart rule will be applied to the first "X" customers only.','d'=>'Admin.Catalog.Help'),$_smarty_tpl ) ) ));?>
">
	...
	<div class="col-lg-9">
		<input class="form-control" type="text" name="quantity" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'quantity') ));?>
" />
	</div>
</div>
...
<div class="form-group">
	<label class="control-label col-lg-3">
		<span class="label-tooltip" data-toggle="tooltip"
			title="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'A customer will only be able to use the cart rule "X" time(s).','d'=>'Admin.Catalog.Help'),$_smarty_tpl ) ) ));?>
">
	...
	<div class="col-lg-9">
		<input class="form-control" type="text" name="quantity_per_user" value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'quantity_per_user') ));?>
" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-lg-9">
		<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['countries']->value['unselected']))+(smarty_modifier_count($_smarty_tpl->tpl_vars['countries']->value['selected'])) > 1) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="country_restriction" name="country_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['countries']->value['unselected'])) {?>checked="checked"<?php }?> />
...
?>
									<option value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['country']->value['id_country'] ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['carriers']->value['unselected']))+(smarty_modifier_count($_smarty_tpl->tpl_vars['carriers']->value['selected'])) > 1) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="carrier_restriction" name="carrier_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['carriers']->value['unselected'])) {?>checked="checked"<?php }?> />
...
?>
									<option value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['carrier']->value['id_reference'] ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['groups']->value['unselected']))+(smarty_modifier_count($_smarty_tpl->tpl_vars['groups']->value['selected'])) > 1) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="group_restriction" name="group_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['groups']->value['unselected'])) {?>checked="checked"<?php }?> />
...
?>
									<option value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['group']->value['id_group'] ));?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['cart_rules']->value['unselected']))+(smarty_modifier_count($_smarty_tpl->tpl_vars['cart_rules']->value['selected'])) > 0) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="cart_rule_restriction" name="cart_rule_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['cart_rules']->value['unselected'])) {?>checked="checked"<?php }?> />
...
" value="">
		...
		<?php }?>
			...
			<p class="checkbox">
				<label>
					<input type="checkbox" id="product_restriction" name="product_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['product_rule_groups']->value)) {?>checked="checked"<?php }?> />
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		...
		<?php if ((smarty_modifier_count($_smarty_tpl->tpl_vars['all_shops']->value)) > 1) {?>
			<p class="checkbox">
				<label>
					<input type="checkbox" id="shop_restriction" name="shop_restriction" value="1" <?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['selected']) || (smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['selected'])+smarty_modifier_count($_smarty_tpl->tpl_vars['shops']->value['unselected']) < smarty_modifier_count($_smarty_tpl->tpl_vars['all_shops']->value))) {?>checked="checked"<?php }?> />
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Store selection','d'=>'Admin.Catalog.Feature'),$_smarty_tpl ) );?>
...
?>
									<option value="<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['shop']->value['id_shop'] ));?>
